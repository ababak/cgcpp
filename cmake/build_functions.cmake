...
function(build_houdini_module HOUDINI_VERSION PROJECT_BUILD_TYPE)
    ...
    elseif (Houdini_VERSION VERSION_EQUAL 20.5)
        ...
        set(BOOST_REQUESTED_VERSION 1.82.0)
        set(BOOST_ROOT "C:/local/boost_1_82_0")
    elseif (Houdini_VERSION VERSION_EQUAL 21.0)
        set(PYTHON_REQUESTED_VERSION 3.11)
        set(Python_ROOT_DIR "C:/Python311")
        set(BOOST_REQUESTED_VERSION 1.85.0)
        set(BOOST_ROOT "C:/local/boost_1_85_0")
    elseif (Houdini_VERSION VERSION_EQUAL 22.0)
        set(PYTHON_REQUESTED_VERSION 3.13)
        set(Python_ROOT_DIR "C:/Python313")
        set(BOOST_REQUESTED_VERSION 1.88.0)
        set(BOOST_ROOT "C:/local/boost_1_88_0")
...
function(build_python_module PYTHON_REQUESTED_VERSION PROJECT_BUILD_TYPE)
    ...
    elseif (PYTHON_REQUESTED_VERSION VERSION_EQUAL 3.12)
        ...
        set (BOOST_REQUESTED_VERSION 1.85.0)
        set (BOOST_ROOT "C:/local/boost_1_85_0")
    elseif (PYTHON_REQUESTED_VERSION VERSION_EQUAL 3.13)
        set (Python_ROOT_DIR "C:/Python313")
        set (BOOST_REQUESTED_VERSION 1.88.0)
        set (BOOST_ROOT "C:/local/boost_1_88_0")
    else ()
